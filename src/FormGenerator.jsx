...
export default function FormGenerator() {
  ...
  const [verifierData, setVerifierData] = useState({ username: 'encoder', password: 'OWWA3141592654!' });
  ...
  useEffect(() => {
    ...
    const verifierPath = `${import.meta.env.BASE_URL}verifier.txt`;
    ...
    fetch(verifierPath)
      ...
      .then((text) => {
        ...
        setVerifierData({
          username: values.username || 'encoder',
          password: values.password || 'OWWA3141592654!',
        });
      })
      .catch(() => {
        setVerifierData({ username: 'encoder', password: 'OWWA3141592654!' });
      });
  }, []);
  ...
  const handleLogin = (event) => {
    ...
    const expectedUsername = verifierData.username || 'encoder';
    const expectedPassword = verifierData.password || 'OWWA3141592654!';
              ...
              <div className="card shadow-sm">
                <div className="card-body">
                  ...
                  <div className="alert alert-secondary py-2 mb-3">
                    <small className="fw-semibold">{versionLabel}</small>
                  </div>
